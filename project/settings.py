...
DATABASES = {
    'default': dj_database_url.parse('postgres://restaurantdatabase_user:lNegL7hxttny5aANXir2xamLJEc87AmK@dpg-ckdt0tdjhfbs7382ql2g-a.frankfurt-postgres.render.com/restaurantdatabase')
}
